...
test("Game deletion with confirmation and verification", async ({
  ...
  try {
    ...
    await test.step("Player verifies game appears in joinable list", async () => {
    ...
    await test.step("Director navigates to delete-game page", async () => {
    ...
    await test.step("Confirmation message displays game event name", async () => {
      await expect(
    ...
    await test.step("Player verifies deleted game no longer appears in joinable list", async () => {
      await playerPage.goto("/join/select-game");
      await playerPage.waitForLoadState("networkidle");
    ...
    await test.step("API confirms game no longer exists in /api/games/all", async () => {
