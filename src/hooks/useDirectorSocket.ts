...
import { DirectorEvent, DirectorServerToClientEvents, DirectorClientToServerEvents } from "@/types/directorSocket"
...
export function useDirectorSocket() {
    ...
    const socketRef = useRef<Socket<DirectorServerToClientEvents, DirectorClientToServerEvents> | null>(null)
