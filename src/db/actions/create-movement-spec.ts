import { individualmovementspec, IndividualMovementSpecInsert, pairmovementspec, PairMovementSpecInsert, teammovementspec, TeamMovementSpecInsert } from "@/db/schema";
import { getDb } from "@/db";

export async function createIndividualMovementSpec(data: IndividualMovementSpecInsert) {
