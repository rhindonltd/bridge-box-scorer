...
describe("EnterPlayerNames", () => {
  it("renders NS labels correctly", () => {
    render(
      <EnterIndividualPlayerNames direction="N" onSubmitPlayer={vi.fn()} />,
    );
  ...
  it("renders EW labels correctly", () => {
    render(
      <EnterIndividualPlayerNames direction="E" onSubmitPlayer={vi.fn()} />,
    );
  ...
  it("submits player names", () => {
    ...
    render(<EnterIndividualPlayerNames direction="N" onSubmitPlayer={fn} />);
