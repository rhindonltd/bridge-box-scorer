...
describe("NumberStepper", () => {
    ...
    it("renders zeroCharacter when value is 0", () => {
        render(
            <NumberStepper value={0} zeroCharacter="ZERO" onChange={vi.fn()} />
        );
    ...
    it("shows + sign when showPlus is enabled", () => {
        render(
            <NumberStepper value={5} showPlus onChange={vi.fn()} />
        );
    ...
    it("does not show + sign when showPlus is false", () => {
        render(
            <NumberStepper value={5} showPlus={false} onChange={vi.fn()} />
        );
