...
describe("TextField", () => {
    ...
    it("renders input with correct value", () => {
        render(
            <TextField label="Name" value="Alice" onChange={vi.fn()} />
        );
    ...
    it("uses label as placeholder", () => {
        render(
            <TextField label="Email" value="" onChange={vi.fn()} />
        );
    ...
    it("calls onChange when typing", async () => {
        ...
        render(
            <TextField label="Name" value="" onChange={onChange} />
        );
    ...
    it("renders correct input type", () => {
        render(
            <TextField label="Test" value="" onChange={vi.fn()} />
        );
