...
vi.mock("../../contract/SuitSection", () => ({
  default: ({ suit, onSuitSelected }: any) => (
    <div data-testid="suit-section">
      <button onClick={() => onSuitSelected("S")}>suit:{suit ?? "null"}</button>
    </div>
  ),
}));
...
vi.mock("../../contract/DoubleSection", () => ({
  default: ({ dbl, onDblSelected }: any) => (
    <div data-testid="double-section">
      <button onClick={() => onDblSelected("X")}>dbl:{dbl ?? "null"}</button>
    </div>
  ),
}));
...
describe("PlayableContract", () => {
  ...
  it("calls onLevelSelected", () => {
    ...
    render(<PlayableContract {...baseProps} onLevelSelected={fn} />);
  ...
  it("calls onSuitSelected", () => {
    ...
    render(<PlayableContract {...baseProps} onSuitSelected={fn} />);
  ...
  it("calls onDeclarerSelected", () => {
    ...
    render(<PlayableContract {...baseProps} onDeclarerSelected={fn} />);
  ...
  it("calls onDblSelected", () => {
    ...
    render(<PlayableContract {...baseProps} onDblSelected={fn} />);
  ...
  it("applies grid layout structure", () => {
    const { container } = render(<PlayableContract {...baseProps} />);
