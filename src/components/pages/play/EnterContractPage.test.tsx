...
vi.mock("@/components/pages/play/PlayableContract", () => ({
    PlayableContract: (props: any) => (
        <div data-testid="playable">
            <button onClick={() => props.onLevelSelected("1")}>
                level
            </button>
            <button onClick={() => props.onSuitSelected("S")}>
                suit
            </button>
            <button onClick={() => props.onDeclarerSelected("N")}>
                declarer
            </button>
            <button onClick={() => props.onDblSelected("X")}>
                dbl
            </button>
        </div>
    ),
...
vi.mock("@/components/contract/PassOutButton", () => ({
    default: ({ onPassOut }: any) => (
        <button onClick={onPassOut}>PassOut</button>
    ),
}));
