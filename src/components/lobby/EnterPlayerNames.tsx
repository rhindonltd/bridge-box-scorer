...
export default function EnterPlayerNames({ direction, submitPlayerNames }: EnterPlayerNamesProps) {
    ...
    return (<div style={container}>
        ...
        <form onSubmit={() => submitPlayerNames(player1Name, player2Name)} style={form}>
            <input
                type="text"
