    ...
    return (
        <div style={container}>
            ...
            <div style={header}>
                ...
                <div style={contractStyle}>{contract}</div>
            ...
            {/* RESULT */}
            <div style={resultRow}>
                <button style={stepButton} onClick={()=>adjustResult(-1)}>−</button>
...
function Section({title,children,gridCols=1}:{title:string,children:React.ReactNode,gridCols?:number}) {
    return (
        <div style={section}>
...
function Button({children,active,onClick,fullWidth=false,flex=0}:{children:any,active:boolean,onClick:()=>void,fullWidth?:boolean,flex?:number}) {
    return (
        <button
            onClick={onClick}
            style={{
