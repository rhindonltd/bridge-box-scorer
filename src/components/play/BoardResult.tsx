...
export function BoardResult({ board, contract, declarer, onSave }: Props) {
  const { requiredTricks } = useMemo(() => parseContract(contract), [contract]);
      ...
      <div className="flex-1 overflow-y-auto space-y-6">
        ...
        <div>
          <div className="mb-2 text-sm text-gray-500">
            {mode === "made" ? "Overtricks" : "Down tricks"}
          </div>
